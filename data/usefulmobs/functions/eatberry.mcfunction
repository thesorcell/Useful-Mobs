...
scoreboard players set @s BatEatingCooldown 200
...
# Remove berry
execute as @e[type=item,nbt={Item:{id:"minecraft:glow_berries"}},distance=..2] run function usefulmobs:removeberry